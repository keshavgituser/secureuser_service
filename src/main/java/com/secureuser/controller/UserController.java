...
import com.secureuser.entity.Advertisement;
...
public class UserController {
	...
	private final String DEALER_ADD_ADVERTISEMENT_URL="http://advertisement-service/advertisement/create";
	...
	@PostMapping("/dealer/{loginName}/addadvertise")
	public ResponseEntity<?> DealerAddAdvertise(@PathVariable String loginName, @RequestBody Advertisement advertisement)
	{
		advertisement.setPostedBy(loginName);
		ResponseEntity<Advertisement> newAdvertisement=restTemplate.postForEntity(DEALER_ADD_ADVERTISEMENT_URL, advertisement, Advertisement.class);
